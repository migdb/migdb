 ...
 * <ul>
 *   <li>{@link mm.app.operations.impl.RenameClassImpl#getName <em>Name</em>}</li>
 *   <li>{@link mm.app.operations.impl.RenameClassImpl#getNewName <em>New Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class RenameClassImpl extends ModelOperationImpl implements RenameClass {
	/**
	...
	protected EClass eStaticClass() {
		return OperationsPackage.Literals.RENAME_CLASS;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OperationsPackage.RENAME_CLASS__NAME, oldName, name));
	}
	...
	public void setNewName(String newNewName) {
		...
		newName = newNewName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OperationsPackage.RENAME_CLASS__NEW_NAME, oldNewName, newName));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OperationsPackage.RENAME_CLASS__NAME:
				return getName();
			case OperationsPackage.RENAME_CLASS__NEW_NAME:
				return getNewName();
		}
