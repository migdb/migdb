 ...
 * <ul>
 *   <li>{@link mm.app.operations.impl.SetUniqueImpl#getOwningClassName <em>Owning Class Name</em>}</li>
 *   <li>{@link mm.app.operations.impl.SetUniqueImpl#getName <em>Name</em>}</li>
 *   <li>{@link mm.app.operations.impl.SetUniqueImpl#isIsUnique <em>Is Unique</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SetUniqueImpl extends ModelOperationImpl implements SetUnique {
	...
	protected EClass eStaticClass() {
		return OperationsPackage.Literals.SET_UNIQUE;
	}
	...
	public void setOwningClassName(String newOwningClassName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OperationsPackage.SET_UNIQUE__OWNING_CLASS_NAME, oldOwningClassName, owningClassName));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OperationsPackage.SET_UNIQUE__NAME, oldName, name));
	}
	...
	public void setIsUnique(boolean newIsUnique) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OperationsPackage.SET_UNIQUE__IS_UNIQUE, oldIsUnique, isUnique));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OperationsPackage.SET_UNIQUE__OWNING_CLASS_NAME:
				return getOwningClassName();
			case OperationsPackage.SET_UNIQUE__NAME:
				return getName();
			case OperationsPackage.SET_UNIQUE__IS_UNIQUE:
				return isIsUnique();
		}
