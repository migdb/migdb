 ...
 *   <li>{@link mm.app.operations.impl.MovePropertyImpl#getPropertyName <em>Property Name</em>}</li>
 *   <li>{@link mm.app.operations.impl.MovePropertyImpl#getTargetClassName <em>Target Class Name</em>}</li>
 *   <li>{@link mm.app.operations.impl.MovePropertyImpl#isEndInOwerload <em>End In Owerload</em>}</li>
 *   <li>{@link mm.app.operations.impl.MovePropertyImpl#isAddValueNull <em>Add Value Null</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MovePropertyImpl extends ModelOperationImpl implements MoveProperty {
	...
	public void setPropertyName(String newPropertyName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OperationsPackage.MOVE_PROPERTY__PROPERTY_NAME, oldPropertyName, propertyName));
	}
	...
	public void setEndInOwerload(boolean newEndInOwerload) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OperationsPackage.MOVE_PROPERTY__END_IN_OWERLOAD, oldEndInOwerload, endInOwerload));
	}
	...
	public void setAddValueNull(boolean newAddValueNull) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OperationsPackage.MOVE_PROPERTY__ADD_VALUE_NULL, oldAddValueNull, addValueNull));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case OperationsPackage.MOVE_PROPERTY__PROPERTY_NAME:
				return getPropertyName();
			case OperationsPackage.MOVE_PROPERTY__TARGET_CLASS_NAME:
				return getTargetClassName();
			case OperationsPackage.MOVE_PROPERTY__END_IN_OWERLOAD:
				return isEndInOwerload();
			case OperationsPackage.MOVE_PROPERTY__ADD_VALUE_NULL:
