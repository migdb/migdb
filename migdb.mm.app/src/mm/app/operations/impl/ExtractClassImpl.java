 ...
 * <ul>
 *   <li>{@link mm.app.operations.impl.ExtractClassImpl#getSourceClassName <em>Source Class Name</em>}</li>
 *   <li>{@link mm.app.operations.impl.ExtractClassImpl#getExtractPropertiesNames <em>Extract Properties Names</em>}</li>
 *   <li>{@link mm.app.operations.impl.ExtractClassImpl#getExtractClassName <em>Extract Class Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ExtractClassImpl extends ModelOperationImpl implements ExtractClass {
	...
	protected EClass eStaticClass() {
		return OperationsPackage.Literals.EXTRACT_CLASS;
	}
	...
	public void setSourceClassName(String newSourceClassName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OperationsPackage.EXTRACT_CLASS__SOURCE_CLASS_NAME, oldSourceClassName, sourceClassName));
	}
	...
	public EList<String> getExtractPropertiesNames() {
		if (extractPropertiesNames == null) {
			extractPropertiesNames = new EDataTypeUniqueEList<String>(String.class, this, OperationsPackage.EXTRACT_CLASS__EXTRACT_PROPERTIES_NAMES);
		}
	...
	public void setExtractClassName(String newExtractClassName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OperationsPackage.EXTRACT_CLASS__EXTRACT_CLASS_NAME, oldExtractClassName, extractClassName));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OperationsPackage.EXTRACT_CLASS__SOURCE_CLASS_NAME:
				return getSourceClassName();
			case OperationsPackage.EXTRACT_CLASS__EXTRACT_PROPERTIES_NAMES:
				return getExtractPropertiesNames();
			case OperationsPackage.EXTRACT_CLASS__EXTRACT_CLASS_NAME:
