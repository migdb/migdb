 ...
 * <ul>
 *   <li>{@link mm.app.operations.impl.AddPrimitiveClassImpl#getName <em>Name</em>}</li>
 *   <li>{@link mm.app.operations.impl.AddPrimitiveClassImpl#getPrimitiveType <em>Primitive Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AddPrimitiveClassImpl extends ModelOperationImpl implements AddPrimitiveClass {
	...
	protected EClass eStaticClass() {
		return OperationsPackage.Literals.ADD_PRIMITIVE_CLASS;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OperationsPackage.ADD_PRIMITIVE_CLASS__NAME, oldName, name));
	}
	...
	public void setPrimitiveType(PrimitiveType newPrimitiveType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OperationsPackage.ADD_PRIMITIVE_CLASS__PRIMITIVE_TYPE, oldPrimitiveType, primitiveType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OperationsPackage.ADD_PRIMITIVE_CLASS__NAME:
				return getName();
			case OperationsPackage.ADD_PRIMITIVE_CLASS__PRIMITIVE_TYPE:
