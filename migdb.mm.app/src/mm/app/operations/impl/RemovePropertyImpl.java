 ...
 * <ul>
 *   <li>{@link mm.app.operations.impl.RemovePropertyImpl#getOwningClassName <em>Owning Class Name</em>}</li>
 *   <li>{@link mm.app.operations.impl.RemovePropertyImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RemovePropertyImpl extends ModelOperationImpl implements RemoveProperty {
	...
	protected EClass eStaticClass() {
		return OperationsPackage.Literals.REMOVE_PROPERTY;
	}
	...
	public void setOwningClassName(String newOwningClassName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OperationsPackage.REMOVE_PROPERTY__OWNING_CLASS_NAME, oldOwningClassName, owningClassName));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OperationsPackage.REMOVE_PROPERTY__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OperationsPackage.REMOVE_PROPERTY__OWNING_CLASS_NAME:
				return getOwningClassName();
			case OperationsPackage.REMOVE_PROPERTY__NAME:
				return getName();
		}
