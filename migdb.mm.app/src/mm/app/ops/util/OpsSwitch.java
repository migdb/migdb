...
public class OpsSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case OpsPackage.ADD_PRIMITIVE_CLASS: {
			...
			case OpsPackage.ADD_EMBEDDED_CLASS: {
			...
			case OpsPackage.RENAME_PROPERTY: {
			...
			case OpsPackage.REMOVE_PROPERTY: {
			...
			case OpsPackage.EXTRACT_CLASS: {
				ExtractClass extractClass = (ExtractClass)theEObject;
				T result = caseExtractClass(extractClass);
				if (result == null) result = caseModelOperation(extractClass);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case OpsPackage.EXTRACT_PARENT: {
				ExtractParent extractParent = (ExtractParent)theEObject;
				T result = caseExtractParent(extractParent);
				if (result == null) result = caseModelOperation(extractParent);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Extract Parent</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Extract Parent</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseExtractParent(ExtractParent object) {
		return null;
	}
