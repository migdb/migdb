 ...
 * <ul>
 *   <li>{@link mm.app.ops.impl.SetParentImpl#getName <em>Name</em>}</li>
 *   <li>{@link mm.app.ops.impl.SetParentImpl#getParentName <em>Parent Name</em>}</li>
 *   <li>{@link mm.app.ops.impl.SetParentImpl#getProperties <em>Properties</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SetParentImpl extends ModelOperationImpl implements SetParent {
	...
	protected EClass eStaticClass() {
		return OpsPackage.Literals.SET_PARENT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpsPackage.SET_PARENT__NAME, oldName, name));
	}
	...
	public void setParentName(String newParentName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpsPackage.SET_PARENT__PARENT_NAME, oldParentName, parentName));
	}
	...
	public EList<String> getProperties() {
		if (properties == null) {
			properties = new EDataTypeUniqueEList<String>(String.class, this, OpsPackage.SET_PARENT__PROPERTIES);
		}
		return properties;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OpsPackage.SET_PARENT__NAME:
				return getName();
			case OpsPackage.SET_PARENT__PARENT_NAME:
				return getParentName();
			case OpsPackage.SET_PARENT__PROPERTIES:
