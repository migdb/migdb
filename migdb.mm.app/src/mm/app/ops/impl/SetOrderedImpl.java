 ...
 * <ul>
 *   <li>{@link mm.app.ops.impl.SetOrderedImpl#getOwningClassName <em>Owning Class Name</em>}</li>
 *   <li>{@link mm.app.ops.impl.SetOrderedImpl#getName <em>Name</em>}</li>
 *   <li>{@link mm.app.ops.impl.SetOrderedImpl#isIsOrdered <em>Is Ordered</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SetOrderedImpl extends ModelOperationImpl implements SetOrdered {
	...
	protected EClass eStaticClass() {
		return OpsPackage.Literals.SET_ORDERED;
	}
	...
	public void setOwningClassName(String newOwningClassName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpsPackage.SET_ORDERED__OWNING_CLASS_NAME, oldOwningClassName, owningClassName));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpsPackage.SET_ORDERED__NAME, oldName, name));
	}
	...
	public void setIsOrdered(boolean newIsOrdered) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpsPackage.SET_ORDERED__IS_ORDERED, oldIsOrdered, isOrdered));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OpsPackage.SET_ORDERED__OWNING_CLASS_NAME:
				return getOwningClassName();
			case OpsPackage.SET_ORDERED__NAME:
				return getName();
			case OpsPackage.SET_ORDERED__IS_ORDERED:
				return isIsOrdered();
		}
