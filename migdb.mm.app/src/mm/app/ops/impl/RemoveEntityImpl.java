 ...
 * <ul>
 *   <li>{@link mm.app.ops.impl.RemoveEntityImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RemoveEntityImpl extends ModelOperationImpl implements RemoveEntity {
	...
	protected EClass eStaticClass() {
		return OpsPackage.Literals.REMOVE_ENTITY;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpsPackage.REMOVE_ENTITY__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OpsPackage.REMOVE_ENTITY__NAME:
				return getName();
		}
