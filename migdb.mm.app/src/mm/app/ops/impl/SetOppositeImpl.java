 ...
 * <ul>
 *   <li>{@link mm.app.ops.impl.SetOppositeImpl#getFirstClassName <em>First Class Name</em>}</li>
 *   <li>{@link mm.app.ops.impl.SetOppositeImpl#getFirstPropertyName <em>First Property Name</em>}</li>
 *   <li>{@link mm.app.ops.impl.SetOppositeImpl#getSecondClassName <em>Second Class Name</em>}</li>
 *   <li>{@link mm.app.ops.impl.SetOppositeImpl#getSecondPropertyName <em>Second Property Name</em>}</li>
 *   <li>{@link mm.app.ops.impl.SetOppositeImpl#isIsOpposite <em>Is Opposite</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SetOppositeImpl extends ModelOperationImpl implements SetOpposite {
	...
	protected EClass eStaticClass() {
		return OpsPackage.Literals.SET_OPPOSITE;
	}
	...
	public void setFirstClassName(String newFirstClassName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpsPackage.SET_OPPOSITE__FIRST_CLASS_NAME, oldFirstClassName, firstClassName));
	}
	...
	public void setFirstPropertyName(String newFirstPropertyName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpsPackage.SET_OPPOSITE__FIRST_PROPERTY_NAME, oldFirstPropertyName, firstPropertyName));
	}
	...
	public void setSecondClassName(String newSecondClassName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpsPackage.SET_OPPOSITE__SECOND_CLASS_NAME, oldSecondClassName, secondClassName));
	}
	...
	public void setSecondPropertyName(String newSecondPropertyName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpsPackage.SET_OPPOSITE__SECOND_PROPERTY_NAME, oldSecondPropertyName, secondPropertyName));
	}
	...
	public void setIsOpposite(boolean newIsOpposite) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpsPackage.SET_OPPOSITE__IS_OPPOSITE, oldIsOpposite, isOpposite));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OpsPackage.SET_OPPOSITE__FIRST_CLASS_NAME:
				return getFirstClassName();
			case OpsPackage.SET_OPPOSITE__FIRST_PROPERTY_NAME:
				return getFirstPropertyName();
			case OpsPackage.SET_OPPOSITE__SECOND_CLASS_NAME:
				return getSecondClassName();
			case OpsPackage.SET_OPPOSITE__SECOND_PROPERTY_NAME:
				return getSecondPropertyName();
			case OpsPackage.SET_OPPOSITE__IS_OPPOSITE:
				return isIsOpposite();
		}
