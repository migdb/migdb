 ...
 * <ul>
 *   <li>{@link mm.app.ops.impl.SetTypeImpl#getOwningClassName <em>Owning Class Name</em>}</li>
 *   <li>{@link mm.app.ops.impl.SetTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link mm.app.ops.impl.SetTypeImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SetTypeImpl extends ModelOperationImpl implements SetType {
	...
	protected EClass eStaticClass() {
		return OpsPackage.Literals.SET_TYPE;
	}
	...
	public void setOwningClassName(String newOwningClassName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpsPackage.SET_TYPE__OWNING_CLASS_NAME, oldOwningClassName, owningClassName));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpsPackage.SET_TYPE__NAME, oldName, name));
	}
	...
	public void setType(String newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpsPackage.SET_TYPE__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OpsPackage.SET_TYPE__OWNING_CLASS_NAME:
				return getOwningClassName();
			case OpsPackage.SET_TYPE__NAME:
				return getName();
			case OpsPackage.SET_TYPE__TYPE:
				return getType();
		}
