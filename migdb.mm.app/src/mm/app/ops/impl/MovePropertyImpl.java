 ...
 * <ul>
 *   <li>{@link mm.app.ops.impl.MovePropertyImpl#getOwningClassName <em>Owning Class Name</em>}</li>
 *   <li>{@link mm.app.ops.impl.MovePropertyImpl#getName <em>Name</em>}</li>
 *   <li>{@link mm.app.ops.impl.MovePropertyImpl#getTargetClassName <em>Target Class Name</em>}</li>
 *   <li>{@link mm.app.ops.impl.MovePropertyImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MovePropertyImpl extends ModelOperationImpl implements MoveProperty {
	...
	protected EClass eStaticClass() {
		return OpsPackage.Literals.MOVE_PROPERTY;
	}
	...
	public void setOwningClassName(String newOwningClassName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpsPackage.MOVE_PROPERTY__OWNING_CLASS_NAME, oldOwningClassName, owningClassName));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpsPackage.MOVE_PROPERTY__NAME, oldName, name));
	}
	...
	public void setTargetClassName(String newTargetClassName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpsPackage.MOVE_PROPERTY__TARGET_CLASS_NAME, oldTargetClassName, targetClassName));
	}
	...
	public void setType(MergeType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpsPackage.MOVE_PROPERTY__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OpsPackage.MOVE_PROPERTY__OWNING_CLASS_NAME:
				return getOwningClassName();
			case OpsPackage.MOVE_PROPERTY__NAME:
				return getName();
			case OpsPackage.MOVE_PROPERTY__TARGET_CLASS_NAME:
				return getTargetClassName();
			case OpsPackage.MOVE_PROPERTY__TYPE:
				return getType();
		}
