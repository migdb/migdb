...
import mm.app.ops.AddEmbeddedClass;
...
import mm.app.ops.MoveProperty;
import mm.app.ops.OpsFactory;
import mm.app.ops.OpsPackage;
import mm.app.ops.RemoveEntity;
import mm.app.ops.RemoveProperty;
import mm.app.ops.RenameEntity;
import mm.app.ops.RenameProperty;
import mm.app.ops.SetAbstract;
import mm.app.ops.SetBoundries;
import mm.app.ops.SetOpposite;
import mm.app.ops.SetOrdered;
import mm.app.ops.SetParent;
import mm.app.ops.SetType;
...
public class OpsPackageImpl extends EPackageImpl implements OpsPackage {
	 ...
	 * @generated
	 */
	private EClass extractParentEClass = null;
	 ...
	 * @see mm.app.ops.OpsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EClass getExtractParent() {
		return extractParentEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getExtractParent_SourceClassesName() {
		return (EAttribute)extractParentEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getExtractParent_ExtractPropertiesName() {
		return (EAttribute)extractParentEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EAttribute getExtractParent_ExtractParentName() {
		return (EAttribute)extractParentEClass.getEStructuralFeatures().get(2);
	}
	...
	public void createPackageContents() {
		...
		extractParentEClass = createEClass(EXTRACT_PARENT);
		createEAttribute(extractParentEClass, EXTRACT_PARENT__SOURCE_CLASSES_NAME);
		createEAttribute(extractParentEClass, EXTRACT_PARENT__EXTRACT_PROPERTIES_NAME);
		createEAttribute(extractParentEClass, EXTRACT_PARENT__EXTRACT_PARENT_NAME);
	...
	public void initializePackageContents() {
		...
		extractParentEClass.getESuperTypes().add(this.getModelOperation());
		...
		initEClass(extractParentEClass, ExtractParent.class, "ExtractParent", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getExtractParent_SourceClassesName(), ecorePackage.getEString(), "sourceClassesName", null, 1, -1, ExtractParent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getExtractParent_ExtractPropertiesName(), ecorePackage.getEString(), "extractPropertiesName", null, 1, -1, ExtractParent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getExtractParent_ExtractParentName(), ecorePackage.getEString(), "extractParentName", null, 1, 1, ExtractParent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
