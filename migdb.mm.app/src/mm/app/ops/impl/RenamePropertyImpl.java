 ...
 * <ul>
 *   <li>{@link mm.app.ops.impl.RenamePropertyImpl#getOwningClassName <em>Owning Class Name</em>}</li>
 *   <li>{@link mm.app.ops.impl.RenamePropertyImpl#getName <em>Name</em>}</li>
 *   <li>{@link mm.app.ops.impl.RenamePropertyImpl#getNewName <em>New Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RenamePropertyImpl extends ModelOperationImpl implements RenameProperty {
	...
	protected EClass eStaticClass() {
		return OpsPackage.Literals.RENAME_PROPERTY;
	}
	...
	public void setOwningClassName(String newOwningClassName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpsPackage.RENAME_PROPERTY__OWNING_CLASS_NAME, oldOwningClassName, owningClassName));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpsPackage.RENAME_PROPERTY__NAME, oldName, name));
	}
	...
	public void setNewName(String newNewName) {
		...
		newName = newNewName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpsPackage.RENAME_PROPERTY__NEW_NAME, oldNewName, newName));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OpsPackage.RENAME_PROPERTY__OWNING_CLASS_NAME:
				return getOwningClassName();
			case OpsPackage.RENAME_PROPERTY__NAME:
				return getName();
			case OpsPackage.RENAME_PROPERTY__NEW_NAME:
				return getNewName();
		}
