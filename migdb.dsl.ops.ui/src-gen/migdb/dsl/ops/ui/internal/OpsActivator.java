 ...
 * generated by Xtext
 */
package migdb.dsl.ops.ui.internal;
 ...
 * introduced subclass. 
 */
public class OpsActivator extends AbstractUIPlugin {
	
	private static final Logger logger = Logger.getLogger(OpsActivator.class);
	...
	private static OpsActivator INSTANCE;
	
	public static final String MIGDB_DSL_OPS_OPS = "migdb.dsl.ops.Ops";
	...
	public static OpsActivator getInstance() {
		return INSTANCE;
	}
	
	protected Module getRuntimeModule(String grammar) {
		if (MIGDB_DSL_OPS_OPS.equals(grammar)) {
			return new migdb.dsl.ops.OpsRuntimeModule();
		}
	...
	protected Module getUiModule(String grammar) {
		if (MIGDB_DSL_OPS_OPS.equals(grammar)) {
			return new migdb.dsl.ops.ui.OpsUiModule(this);
		}
