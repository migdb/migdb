...
public interface RdbPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int CONSTRAINT__OWNING_TABLE = 1;

	/**
	 * The feature id for the '<em><b>Owning Column</b></em>' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int CONSTRAINT__OWNING_COLUMN = 2;
	...
	/**
	 * The meta object id for the '{@link mm.rdb.impl.UniqueImpl <em>Unique</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see mm.rdb.impl.UniqueImpl
	 * @see mm.rdb.impl.RdbPackageImpl#getUnique()
	 * @generated
	 */
	int UNIQUE = 8;
	 ...
	 * @ordered
	 */
	int UNIQUE__OWNING_TABLE = CONSTRAINT__OWNING_TABLE;
	 ...
	 * @ordered
	 */
	int UNIQUE__OWNING_COLUMN = CONSTRAINT__OWNING_COLUMN;
	 ...
	 * @ordered
	 */
	int UNIQUE_FEATURE_COUNT = CONSTRAINT_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int PRIMARY_KEY__OWNING_TABLE = CONSTRAINT__OWNING_TABLE;
	 ...
	 * @ordered
	 */
	int PRIMARY_KEY__OWNING_COLUMN = CONSTRAINT__OWNING_COLUMN;
	 ...
	 * @ordered
	 */
	int FOREIGN_KEY__OWNING_TABLE = CONSTRAINT__OWNING_TABLE;
	 ...
	 * @ordered
	 */
	int FOREIGN_KEY__OWNING_COLUMN = CONSTRAINT__OWNING_COLUMN;
	 ...
	 * @ordered
	 */
	int FOREIGN_KEY__TARGET_TABLE = CONSTRAINT_FEATURE_COUNT + 0;
	...
	/**
	 * The meta object id for the '{@link mm.rdb.impl.NotNullImpl <em>Not Null</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see mm.rdb.impl.NotNullImpl
	 * @see mm.rdb.impl.RdbPackageImpl#getNotNull()
	 * @generated
	 */
	int NOT_NULL = 11;
	 ...
	 * @ordered
	 */
	int NOT_NULL__OWNING_TABLE = CONSTRAINT__OWNING_TABLE;
	 ...
	 * @ordered
	 */
	int NOT_NULL__OWNING_COLUMN = CONSTRAINT__OWNING_COLUMN;
	 ...
	 * @ordered
	 */
	int NOT_NULL_FEATURE_COUNT = CONSTRAINT_FEATURE_COUNT + 0;
	...
	/**
	 * Returns the meta object for the reference '{@link mm.rdb.Constraint#getOwningTable <em>Owning Table</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Owning Table</em>'.
	 * @see mm.rdb.Constraint#getOwningTable()
	 * @see #getConstraint()
	 * @generated
	 */
	EReference getConstraint_OwningTable();

	/**
	 * Returns the meta object for the reference '{@link mm.rdb.Constraint#getOwningColumn <em>Owning Column</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Owning Column</em>'.
	 * @see mm.rdb.Constraint#getOwningColumn()
	 * @see #getConstraint()
	 * @generated
	 */
	EReference getConstraint_OwningColumn();

	/**
	 * Returns the meta object for class '{@link mm.rdb.Unique <em>Unique</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for class '{@link mm.rdb.NotNull <em>Not Null</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EReference CONSTRAINT__OWNING_TABLE = eINSTANCE.getConstraint_OwningTable();

		/**
		 * The meta object literal for the '<em><b>Owning Column</b></em>' reference feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference CONSTRAINT__OWNING_COLUMN = eINSTANCE.getConstraint_OwningColumn();

		/**
		 * The meta object literal for the '{@link mm.rdb.impl.UniqueImpl <em>Unique</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see mm.rdb.impl.UniqueImpl
		 * @see mm.rdb.impl.RdbPackageImpl#getUnique()
		...
		/**
		 * The meta object literal for the '{@link mm.rdb.impl.NotNullImpl <em>Not Null</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see mm.rdb.impl.NotNullImpl
		 * @see mm.rdb.impl.RdbPackageImpl#getNotNull()
