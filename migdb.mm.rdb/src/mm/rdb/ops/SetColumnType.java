 ...
 * <ul>
 *   <li>{@link mm.rdb.ops.SetColumnType#getOwningSchemaName <em>Owning Schema Name</em>}</li>
 *   <li>{@link mm.rdb.ops.SetColumnType#getOwningTableName <em>Owning Table Name</em>}</li>
 *   <li>{@link mm.rdb.ops.SetColumnType#getOwningColumnName <em>Owning Column Name</em>}</li>
 *   <li>{@link mm.rdb.ops.SetColumnType#getNewType <em>New Type</em>}</li>
 *   <li>{@link mm.rdb.ops.SetColumnType#getOldType <em>Old Type</em>}</li>
 * </ul>
 * </p>
 *
 * @see mm.rdb.ops.OpsPackage#getSetColumnType()
 * @model
 * @generated
 */
public interface SetColumnType extends ModelOperation {
	 ...
	 * @see mm.rdb.ops.OpsPackage#getSetColumnType_OwningSchemaName()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link mm.rdb.ops.SetColumnType#getOwningSchemaName <em>Owning Schema Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see mm.rdb.ops.OpsPackage#getSetColumnType_OwningTableName()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link mm.rdb.ops.SetColumnType#getOwningTableName <em>Owning Table Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see mm.rdb.ops.OpsPackage#getSetColumnType_OwningColumnName()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link mm.rdb.ops.SetColumnType#getOwningColumnName <em>Owning Column Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see mm.rdb.ops.OpsPackage#getSetColumnType_NewType()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link mm.rdb.ops.SetColumnType#getNewType <em>New Type</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see mm.rdb.ops.OpsPackage#getSetColumnType_OldType()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link mm.rdb.ops.SetColumnType#getOldType <em>Old Type</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
