 ...
 * <ul>
 *   <li>{@link mm.rdb.ops.RenameColumn#getOwningSchemaName <em>Owning Schema Name</em>}</li>
 *   <li>{@link mm.rdb.ops.RenameColumn#getOwningTableName <em>Owning Table Name</em>}</li>
 *   <li>{@link mm.rdb.ops.RenameColumn#getName <em>Name</em>}</li>
 *   <li>{@link mm.rdb.ops.RenameColumn#getNewName <em>New Name</em>}</li>
 * </ul>
 * </p>
 *
 * @see mm.rdb.ops.OpsPackage#getRenameColumn()
 * @model
 * @generated
 */
public interface RenameColumn extends ModelOperation {
	 ...
	 * @see mm.rdb.ops.OpsPackage#getRenameColumn_OwningSchemaName()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link mm.rdb.ops.RenameColumn#getOwningSchemaName <em>Owning Schema Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see mm.rdb.ops.OpsPackage#getRenameColumn_OwningTableName()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link mm.rdb.ops.RenameColumn#getOwningTableName <em>Owning Table Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setName(String)
	 * @see mm.rdb.ops.OpsPackage#getRenameColumn_Name()
	 * @model required="true"
	 * @generated
	 */
	String getName();
	...
	/**
	 * Sets the value of the '{@link mm.rdb.ops.RenameColumn#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see mm.rdb.ops.OpsPackage#getRenameColumn_NewName()
	 * @model required="true"
	 * @generated
	 */
	String getNewName();
	...
	/**
	 * Sets the value of the '{@link mm.rdb.ops.RenameColumn#getNewName <em>New Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
