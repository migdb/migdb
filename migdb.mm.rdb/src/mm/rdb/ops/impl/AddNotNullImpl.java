...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Add Not Null</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link mm.rdb.ops.impl.AddNotNullImpl#getOwningSchemaName <em>Owning Schema Name</em>}</li>
 *   <li>{@link mm.rdb.ops.impl.AddNotNullImpl#getOwningTableName <em>Owning Table Name</em>}</li>
 *   <li>{@link mm.rdb.ops.impl.AddNotNullImpl#getOwningColumnName <em>Owning Column Name</em>}</li>
 *   <li>{@link mm.rdb.ops.impl.AddNotNullImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class AddNotNullImpl extends ModelOperationImpl implements AddNotNull {
	/**
	...
	protected EClass eStaticClass() {
		return OpsPackage.Literals.ADD_NOT_NULL;
	}
	...
	public void setOwningSchemaName(String newOwningSchemaName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpsPackage.ADD_NOT_NULL__OWNING_SCHEMA_NAME, oldOwningSchemaName, owningSchemaName));
	}
	...
	public void setOwningTableName(String newOwningTableName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpsPackage.ADD_NOT_NULL__OWNING_TABLE_NAME, oldOwningTableName, owningTableName));
	}
	...
	public void setOwningColumnName(String newOwningColumnName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpsPackage.ADD_NOT_NULL__OWNING_COLUMN_NAME, oldOwningColumnName, owningColumnName));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpsPackage.ADD_NOT_NULL__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OpsPackage.ADD_NOT_NULL__OWNING_SCHEMA_NAME:
				return getOwningSchemaName();
			case OpsPackage.ADD_NOT_NULL__OWNING_TABLE_NAME:
				return getOwningTableName();
			case OpsPackage.ADD_NOT_NULL__OWNING_COLUMN_NAME:
				return getOwningColumnName();
			case OpsPackage.ADD_NOT_NULL__NAME:
				return getName();
		}
