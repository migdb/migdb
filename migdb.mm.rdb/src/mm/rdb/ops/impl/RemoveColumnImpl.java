 ...
 * <ul>
 *   <li>{@link mm.rdb.ops.impl.RemoveColumnImpl#getOwningSchemaName <em>Owning Schema Name</em>}</li>
 *   <li>{@link mm.rdb.ops.impl.RemoveColumnImpl#getOwningTableName <em>Owning Table Name</em>}</li>
 *   <li>{@link mm.rdb.ops.impl.RemoveColumnImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RemoveColumnImpl extends ModelOperationImpl implements RemoveColumn {
	...
	protected EClass eStaticClass() {
		return OpsPackage.Literals.REMOVE_COLUMN;
	}
	...
	public void setOwningSchemaName(String newOwningSchemaName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpsPackage.REMOVE_COLUMN__OWNING_SCHEMA_NAME, oldOwningSchemaName, owningSchemaName));
	}
	...
	public void setOwningTableName(String newOwningTableName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpsPackage.REMOVE_COLUMN__OWNING_TABLE_NAME, oldOwningTableName, owningTableName));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpsPackage.REMOVE_COLUMN__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OpsPackage.REMOVE_COLUMN__OWNING_SCHEMA_NAME:
				return getOwningSchemaName();
			case OpsPackage.REMOVE_COLUMN__OWNING_TABLE_NAME:
				return getOwningTableName();
			case OpsPackage.REMOVE_COLUMN__NAME:
				return getName();
		}
