 ...
 * <ul>
 *   <li>{@link mm.rdb.ops.impl.RemoveSequenceImpl#getSequenceName <em>Sequence Name</em>}</li>
 *   <li>{@link mm.rdb.ops.impl.RemoveSequenceImpl#getOwningSchemaName <em>Owning Schema Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RemoveSequenceImpl extends ModelOperationImpl implements RemoveSequence {
	...
	protected EClass eStaticClass() {
		return OpsPackage.Literals.REMOVE_SEQUENCE;
	}
	...
	public void setSequenceName(String newSequenceName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpsPackage.REMOVE_SEQUENCE__SEQUENCE_NAME, oldSequenceName, sequenceName));
	}
	...
	public void setOwningSchemaName(String newOwningSchemaName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpsPackage.REMOVE_SEQUENCE__OWNING_SCHEMA_NAME, oldOwningSchemaName, owningSchemaName));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OpsPackage.REMOVE_SEQUENCE__SEQUENCE_NAME:
				return getSequenceName();
			case OpsPackage.REMOVE_SEQUENCE__OWNING_SCHEMA_NAME:
