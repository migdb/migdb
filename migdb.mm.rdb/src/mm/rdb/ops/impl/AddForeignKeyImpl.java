 ...
 * <ul>
 *   <li>{@link mm.rdb.ops.impl.AddForeignKeyImpl#getOwningSchemaName <em>Owning Schema Name</em>}</li>
 *   <li>{@link mm.rdb.ops.impl.AddForeignKeyImpl#getOwningTableName <em>Owning Table Name</em>}</li>
 *   <li>{@link mm.rdb.ops.impl.AddForeignKeyImpl#getOwningColumnName <em>Owning Column Name</em>}</li>
 *   <li>{@link mm.rdb.ops.impl.AddForeignKeyImpl#getName <em>Name</em>}</li>
 *   <li>{@link mm.rdb.ops.impl.AddForeignKeyImpl#getTargetTableName <em>Target Table Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AddForeignKeyImpl extends ModelOperationImpl implements AddForeignKey {
	...
	protected EClass eStaticClass() {
		return OpsPackage.Literals.ADD_FOREIGN_KEY;
	}
	...
	public void setOwningSchemaName(String newOwningSchemaName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpsPackage.ADD_FOREIGN_KEY__OWNING_SCHEMA_NAME, oldOwningSchemaName, owningSchemaName));
	}
	...
	public void setOwningTableName(String newOwningTableName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpsPackage.ADD_FOREIGN_KEY__OWNING_TABLE_NAME, oldOwningTableName, owningTableName));
	}
	...
	public void setOwningColumnName(String newOwningColumnName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpsPackage.ADD_FOREIGN_KEY__OWNING_COLUMN_NAME, oldOwningColumnName, owningColumnName));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpsPackage.ADD_FOREIGN_KEY__NAME, oldName, name));
	}
	...
	public void setTargetTableName(String newTargetTableName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpsPackage.ADD_FOREIGN_KEY__TARGET_TABLE_NAME, oldTargetTableName, targetTableName));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OpsPackage.ADD_FOREIGN_KEY__OWNING_SCHEMA_NAME:
				return getOwningSchemaName();
			case OpsPackage.ADD_FOREIGN_KEY__OWNING_TABLE_NAME:
				return getOwningTableName();
			case OpsPackage.ADD_FOREIGN_KEY__OWNING_COLUMN_NAME:
				return getOwningColumnName();
			case OpsPackage.ADD_FOREIGN_KEY__NAME:
				return getName();
			case OpsPackage.ADD_FOREIGN_KEY__TARGET_TABLE_NAME:
