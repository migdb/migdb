 ...
 * <ul>
 *   <li>{@link mm.rdb.ops.impl.AddTableImpl#getOwningSchemaName <em>Owning Schema Name</em>}</li>
 *   <li>{@link mm.rdb.ops.impl.AddTableImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AddTableImpl extends ModelOperationImpl implements AddTable {
	...
	protected EClass eStaticClass() {
		return OpsPackage.Literals.ADD_TABLE;
	}
	...
	public void setOwningSchemaName(String newOwningSchemaName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpsPackage.ADD_TABLE__OWNING_SCHEMA_NAME, oldOwningSchemaName, owningSchemaName));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpsPackage.ADD_TABLE__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OpsPackage.ADD_TABLE__OWNING_SCHEMA_NAME:
				return getOwningSchemaName();
			case OpsPackage.ADD_TABLE__NAME:
				return getName();
		}
