 ...
 * <ul>
 *   <li>{@link mm.rdb.ops.impl.AddColumnImpl#getOwningSchemaName <em>Owning Schema Name</em>}</li>
 *   <li>{@link mm.rdb.ops.impl.AddColumnImpl#getOwningTableName <em>Owning Table Name</em>}</li>
 *   <li>{@link mm.rdb.ops.impl.AddColumnImpl#getName <em>Name</em>}</li>
 *   <li>{@link mm.rdb.ops.impl.AddColumnImpl#getType <em>Type</em>}</li>
 *   <li>{@link mm.rdb.ops.impl.AddColumnImpl#getDefaultValue <em>Default Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AddColumnImpl extends ModelOperationImpl implements AddColumn {
	...
	protected EClass eStaticClass() {
		return OpsPackage.Literals.ADD_COLUMN;
	}
	...
	public void setOwningSchemaName(String newOwningSchemaName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpsPackage.ADD_COLUMN__OWNING_SCHEMA_NAME, oldOwningSchemaName, owningSchemaName));
	}
	...
	public void setOwningTableName(String newOwningTableName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpsPackage.ADD_COLUMN__OWNING_TABLE_NAME, oldOwningTableName, owningTableName));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpsPackage.ADD_COLUMN__NAME, oldName, name));
	}
	...
	public void setType(PrimitiveType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpsPackage.ADD_COLUMN__TYPE, oldType, type));
	}
	...
	public void setDefaultValue(String newDefaultValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpsPackage.ADD_COLUMN__DEFAULT_VALUE, oldDefaultValue, defaultValue));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OpsPackage.ADD_COLUMN__OWNING_SCHEMA_NAME:
				return getOwningSchemaName();
			case OpsPackage.ADD_COLUMN__OWNING_TABLE_NAME:
				return getOwningTableName();
			case OpsPackage.ADD_COLUMN__NAME:
				return getName();
			case OpsPackage.ADD_COLUMN__TYPE:
				return getType();
			case OpsPackage.ADD_COLUMN__DEFAULT_VALUE:
