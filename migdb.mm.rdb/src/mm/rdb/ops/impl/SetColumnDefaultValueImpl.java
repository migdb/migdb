 ...
 * <ul>
 *   <li>{@link mm.rdb.ops.impl.SetColumnDefaultValueImpl#getOwningSchemaName <em>Owning Schema Name</em>}</li>
 *   <li>{@link mm.rdb.ops.impl.SetColumnDefaultValueImpl#getOwningTableName <em>Owning Table Name</em>}</li>
 *   <li>{@link mm.rdb.ops.impl.SetColumnDefaultValueImpl#getOwningColumnName <em>Owning Column Name</em>}</li>
 *   <li>{@link mm.rdb.ops.impl.SetColumnDefaultValueImpl#getNewDefaultValue <em>New Default Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SetColumnDefaultValueImpl extends ModelOperationImpl implements SetColumnDefaultValue {
	...
	protected EClass eStaticClass() {
		return OpsPackage.Literals.SET_COLUMN_DEFAULT_VALUE;
	}
	...
	public void setOwningSchemaName(String newOwningSchemaName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpsPackage.SET_COLUMN_DEFAULT_VALUE__OWNING_SCHEMA_NAME, oldOwningSchemaName, owningSchemaName));
	}
	...
	public void setOwningTableName(String newOwningTableName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpsPackage.SET_COLUMN_DEFAULT_VALUE__OWNING_TABLE_NAME, oldOwningTableName, owningTableName));
	}
	...
	public void setOwningColumnName(String newOwningColumnName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpsPackage.SET_COLUMN_DEFAULT_VALUE__OWNING_COLUMN_NAME, oldOwningColumnName, owningColumnName));
	}
	...
	public void setNewDefaultValue(String newNewDefaultValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpsPackage.SET_COLUMN_DEFAULT_VALUE__NEW_DEFAULT_VALUE, oldNewDefaultValue, newDefaultValue));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OpsPackage.SET_COLUMN_DEFAULT_VALUE__OWNING_SCHEMA_NAME:
				return getOwningSchemaName();
			case OpsPackage.SET_COLUMN_DEFAULT_VALUE__OWNING_TABLE_NAME:
				return getOwningTableName();
			case OpsPackage.SET_COLUMN_DEFAULT_VALUE__OWNING_COLUMN_NAME:
				return getOwningColumnName();
			case OpsPackage.SET_COLUMN_DEFAULT_VALUE__NEW_DEFAULT_VALUE:
