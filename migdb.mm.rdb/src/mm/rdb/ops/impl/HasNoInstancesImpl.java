...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Has No Instances</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link mm.rdb.ops.impl.HasNoInstancesImpl#getOwningSchemaName <em>Owning Schema Name</em>}</li>
 *   <li>{@link mm.rdb.ops.impl.HasNoInstancesImpl#getTableName <em>Table Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class HasNoInstancesImpl extends ModelOperationImpl implements HasNoInstances {
	/**
	...
	protected EClass eStaticClass() {
		return OpsPackage.Literals.HAS_NO_INSTANCES;
	}
	...
	public void setOwningSchemaName(String newOwningSchemaName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpsPackage.HAS_NO_INSTANCES__OWNING_SCHEMA_NAME, oldOwningSchemaName, owningSchemaName));
	}
	...
	public void setTableName(String newTableName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpsPackage.HAS_NO_INSTANCES__TABLE_NAME, oldTableName, tableName));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OpsPackage.HAS_NO_INSTANCES__OWNING_SCHEMA_NAME:
				return getOwningSchemaName();
			case OpsPackage.HAS_NO_INSTANCES__TABLE_NAME:
				return getTableName();
		}
