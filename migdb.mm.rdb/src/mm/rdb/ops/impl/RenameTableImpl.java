 ...
 * <ul>
 *   <li>{@link mm.rdb.ops.impl.RenameTableImpl#getOwningSchemaName <em>Owning Schema Name</em>}</li>
 *   <li>{@link mm.rdb.ops.impl.RenameTableImpl#getName <em>Name</em>}</li>
 *   <li>{@link mm.rdb.ops.impl.RenameTableImpl#getNewName <em>New Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RenameTableImpl extends ModelOperationImpl implements RenameTable {
	...
	protected EClass eStaticClass() {
		return OpsPackage.Literals.RENAME_TABLE;
	}
	...
	public void setOwningSchemaName(String newOwningSchemaName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpsPackage.RENAME_TABLE__OWNING_SCHEMA_NAME, oldOwningSchemaName, owningSchemaName));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpsPackage.RENAME_TABLE__NAME, oldName, name));
	}
	...
	public void setNewName(String newNewName) {
		...
		newName = newNewName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpsPackage.RENAME_TABLE__NEW_NAME, oldNewName, newName));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OpsPackage.RENAME_TABLE__OWNING_SCHEMA_NAME:
				return getOwningSchemaName();
			case OpsPackage.RENAME_TABLE__NAME:
				return getName();
			case OpsPackage.RENAME_TABLE__NEW_NAME:
				return getNewName();
		}
