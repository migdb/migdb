 ...
 * <ul>
 *   <li>{@link mm.rdb.ops.impl.RemoveIndexImpl#getOwningSchemaName <em>Owning Schema Name</em>}</li>
 *   <li>{@link mm.rdb.ops.impl.RemoveIndexImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RemoveIndexImpl extends ModelOperationImpl implements RemoveIndex {
	...
	protected EClass eStaticClass() {
		return OpsPackage.Literals.REMOVE_INDEX;
	}
	...
	public void setOwningSchemaName(String newOwningSchemaName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpsPackage.REMOVE_INDEX__OWNING_SCHEMA_NAME, oldOwningSchemaName, owningSchemaName));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpsPackage.REMOVE_INDEX__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OpsPackage.REMOVE_INDEX__OWNING_SCHEMA_NAME:
				return getOwningSchemaName();
			case OpsPackage.REMOVE_INDEX__NAME:
				return getName();
		}
