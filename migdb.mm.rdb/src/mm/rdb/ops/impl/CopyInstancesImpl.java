 ...
 * <ul>
 *   <li>{@link mm.rdb.ops.impl.CopyInstancesImpl#getOwningSchemaName <em>Owning Schema Name</em>}</li>
 *   <li>{@link mm.rdb.ops.impl.CopyInstancesImpl#getOwningTableName <em>Owning Table Name</em>}</li>
 *   <li>{@link mm.rdb.ops.impl.CopyInstancesImpl#getSourceColumnName <em>Source Column Name</em>}</li>
 *   <li>{@link mm.rdb.ops.impl.CopyInstancesImpl#getTargetTableName <em>Target Table Name</em>}</li>
 *   <li>{@link mm.rdb.ops.impl.CopyInstancesImpl#getTargetColumnName <em>Target Column Name</em>}</li>
 *   <li>{@link mm.rdb.ops.impl.CopyInstancesImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CopyInstancesImpl extends ModelOperationImpl implements CopyInstances {
	...
	protected EClass eStaticClass() {
		return OpsPackage.Literals.COPY_INSTANCES;
	}
	...
	public void setOwningSchemaName(String newOwningSchemaName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpsPackage.COPY_INSTANCES__OWNING_SCHEMA_NAME, oldOwningSchemaName, owningSchemaName));
	}
	...
	public void setOwningTableName(String newOwningTableName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpsPackage.COPY_INSTANCES__OWNING_TABLE_NAME, oldOwningTableName, owningTableName));
	}
	...
	public void setSourceColumnName(String newSourceColumnName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpsPackage.COPY_INSTANCES__SOURCE_COLUMN_NAME, oldSourceColumnName, sourceColumnName));
	}
	...
	public void setTargetTableName(String newTargetTableName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpsPackage.COPY_INSTANCES__TARGET_TABLE_NAME, oldTargetTableName, targetTableName));
	}
	...
	public void setTargetColumnName(String newTargetColumnName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpsPackage.COPY_INSTANCES__TARGET_COLUMN_NAME, oldTargetColumnName, targetColumnName));
	}
	...
	public void setType(MergeType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpsPackage.COPY_INSTANCES__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OpsPackage.COPY_INSTANCES__OWNING_SCHEMA_NAME:
				return getOwningSchemaName();
			case OpsPackage.COPY_INSTANCES__OWNING_TABLE_NAME:
				return getOwningTableName();
			case OpsPackage.COPY_INSTANCES__SOURCE_COLUMN_NAME:
				return getSourceColumnName();
			case OpsPackage.COPY_INSTANCES__TARGET_TABLE_NAME:
				return getTargetTableName();
			case OpsPackage.COPY_INSTANCES__TARGET_COLUMN_NAME:
				return getTargetColumnName();
			case OpsPackage.COPY_INSTANCES__TYPE:
				return getType();
		}
