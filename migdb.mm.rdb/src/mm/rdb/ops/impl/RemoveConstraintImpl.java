 ...
 * <ul>
 *   <li>{@link mm.rdb.ops.impl.RemoveConstraintImpl#getOwningSchemaName <em>Owning Schema Name</em>}</li>
 *   <li>{@link mm.rdb.ops.impl.RemoveConstraintImpl#getOwningTableName <em>Owning Table Name</em>}</li>
 *   <li>{@link mm.rdb.ops.impl.RemoveConstraintImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class RemoveConstraintImpl extends ModelOperationImpl implements RemoveConstraint {
	/**
	...
	protected EClass eStaticClass() {
		return OpsPackage.Literals.REMOVE_CONSTRAINT;
	}
	...
	public void setOwningSchemaName(String newOwningSchemaName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpsPackage.REMOVE_CONSTRAINT__OWNING_SCHEMA_NAME, oldOwningSchemaName, owningSchemaName));
	}
	...
	public void setOwningTableName(String newOwningTableName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpsPackage.REMOVE_CONSTRAINT__OWNING_TABLE_NAME, oldOwningTableName, owningTableName));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpsPackage.REMOVE_CONSTRAINT__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OpsPackage.REMOVE_CONSTRAINT__OWNING_SCHEMA_NAME:
				return getOwningSchemaName();
			case OpsPackage.REMOVE_CONSTRAINT__OWNING_TABLE_NAME:
				return getOwningTableName();
			case OpsPackage.REMOVE_CONSTRAINT__NAME:
				return getName();
		}
