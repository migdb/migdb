 ...
 * <ul>
 *   <li>{@link mm.rdb.ops.impl.AddInstancesImpl#getOwningSchemaName <em>Owning Schema Name</em>}</li>
 *   <li>{@link mm.rdb.ops.impl.AddInstancesImpl#getSourceTableName <em>Source Table Name</em>}</li>
 *   <li>{@link mm.rdb.ops.impl.AddInstancesImpl#getTargetTableNames <em>Target Table Names</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AddInstancesImpl extends ModelOperationImpl implements AddInstances {
	...
	protected EClass eStaticClass() {
		return OpsPackage.Literals.ADD_INSTANCES;
	}
	...
	public void setOwningSchemaName(String newOwningSchemaName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpsPackage.ADD_INSTANCES__OWNING_SCHEMA_NAME, oldOwningSchemaName, owningSchemaName));
	}
	...
	public void setSourceTableName(String newSourceTableName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpsPackage.ADD_INSTANCES__SOURCE_TABLE_NAME, oldSourceTableName, sourceTableName));
	}
	...
	public EList<String> getTargetTableNames() {
		if (targetTableNames == null) {
			targetTableNames = new EDataTypeUniqueEList<String>(String.class, this, OpsPackage.ADD_INSTANCES__TARGET_TABLE_NAMES);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OpsPackage.ADD_INSTANCES__OWNING_SCHEMA_NAME:
				return getOwningSchemaName();
			case OpsPackage.ADD_INSTANCES__SOURCE_TABLE_NAME:
				return getSourceTableName();
			case OpsPackage.ADD_INSTANCES__TARGET_TABLE_NAMES:
