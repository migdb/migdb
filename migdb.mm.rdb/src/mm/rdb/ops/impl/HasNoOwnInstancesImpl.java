 ...
 * <ul>
 *   <li>{@link mm.rdb.ops.impl.HasNoOwnInstancesImpl#getOwningSchemaName <em>Owning Schema Name</em>}</li>
 *   <li>{@link mm.rdb.ops.impl.HasNoOwnInstancesImpl#getTableName <em>Table Name</em>}</li>
 *   <li>{@link mm.rdb.ops.impl.HasNoOwnInstancesImpl#getDescendantsNames <em>Descendants Names</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class HasNoOwnInstancesImpl extends ModelOperationImpl implements HasNoOwnInstances {
	...
	protected EClass eStaticClass() {
		return OpsPackage.Literals.HAS_NO_OWN_INSTANCES;
	}
	...
	public void setOwningSchemaName(String newOwningSchemaName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpsPackage.HAS_NO_OWN_INSTANCES__OWNING_SCHEMA_NAME, oldOwningSchemaName, owningSchemaName));
	}
	...
	public void setTableName(String newTableName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpsPackage.HAS_NO_OWN_INSTANCES__TABLE_NAME, oldTableName, tableName));
	}
	...
	public EList<String> getDescendantsNames() {
		if (descendantsNames == null) {
			descendantsNames = new EDataTypeUniqueEList<String>(String.class, this, OpsPackage.HAS_NO_OWN_INSTANCES__DESCENDANTS_NAMES);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OpsPackage.HAS_NO_OWN_INSTANCES__OWNING_SCHEMA_NAME:
				return getOwningSchemaName();
			case OpsPackage.HAS_NO_OWN_INSTANCES__TABLE_NAME:
				return getTableName();
			case OpsPackage.HAS_NO_OWN_INSTANCES__DESCENDANTS_NAMES:
