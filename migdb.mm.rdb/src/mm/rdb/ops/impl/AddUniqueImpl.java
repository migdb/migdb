...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Add Unique</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link mm.rdb.ops.impl.AddUniqueImpl#getOwningSchemaName <em>Owning Schema Name</em>}</li>
 *   <li>{@link mm.rdb.ops.impl.AddUniqueImpl#getOwningTableName <em>Owning Table Name</em>}</li>
 *   <li>{@link mm.rdb.ops.impl.AddUniqueImpl#getName <em>Name</em>}</li>
 *   <li>{@link mm.rdb.ops.impl.AddUniqueImpl#getOwningColumnName <em>Owning Column Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class AddUniqueImpl extends ModelOperationImpl implements AddUnique {
	/**
	...
	protected EClass eStaticClass() {
		return OpsPackage.Literals.ADD_UNIQUE;
	}
	...
	public void setOwningSchemaName(String newOwningSchemaName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpsPackage.ADD_UNIQUE__OWNING_SCHEMA_NAME, oldOwningSchemaName, owningSchemaName));
	}
	...
	public void setOwningTableName(String newOwningTableName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpsPackage.ADD_UNIQUE__OWNING_TABLE_NAME, oldOwningTableName, owningTableName));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpsPackage.ADD_UNIQUE__NAME, oldName, name));
	}
	...
	public void setOwningColumnName(String newOwningColumnName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpsPackage.ADD_UNIQUE__OWNING_COLUMN_NAME, oldOwningColumnName, owningColumnName));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OpsPackage.ADD_UNIQUE__OWNING_SCHEMA_NAME:
				return getOwningSchemaName();
			case OpsPackage.ADD_UNIQUE__OWNING_TABLE_NAME:
				return getOwningTableName();
			case OpsPackage.ADD_UNIQUE__NAME:
				return getName();
			case OpsPackage.ADD_UNIQUE__OWNING_COLUMN_NAME:
