 ...
 * <ul>
 *   <li>{@link mm.rdb.ops.impl.AddSequenceImpl#getOwningSchemaName <em>Owning Schema Name</em>}</li>
 *   <li>{@link mm.rdb.ops.impl.AddSequenceImpl#getName <em>Name</em>}</li>
 *   <li>{@link mm.rdb.ops.impl.AddSequenceImpl#getStartValue <em>Start Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AddSequenceImpl extends ModelOperationImpl implements AddSequence {
	...
	protected EClass eStaticClass() {
		return OpsPackage.Literals.ADD_SEQUENCE;
	}
	...
	public void setOwningSchemaName(String newOwningSchemaName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpsPackage.ADD_SEQUENCE__OWNING_SCHEMA_NAME, oldOwningSchemaName, owningSchemaName));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpsPackage.ADD_SEQUENCE__NAME, oldName, name));
	}
	...
	public void setStartValue(int newStartValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpsPackage.ADD_SEQUENCE__START_VALUE, oldStartValue, startValue));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OpsPackage.ADD_SEQUENCE__OWNING_SCHEMA_NAME:
				return getOwningSchemaName();
			case OpsPackage.ADD_SEQUENCE__NAME:
				return getName();
			case OpsPackage.ADD_SEQUENCE__START_VALUE:
