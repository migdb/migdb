 ...
 * <ul>
 *   <li>{@link mm.rdb.ops.AddIndex#getOwningSchemaName <em>Owning Schema Name</em>}</li>
 *   <li>{@link mm.rdb.ops.AddIndex#getOwningTableName <em>Owning Table Name</em>}</li>
 *   <li>{@link mm.rdb.ops.AddIndex#getName <em>Name</em>}</li>
 *   <li>{@link mm.rdb.ops.AddIndex#getColumnsNames <em>Columns Names</em>}</li>
 * </ul>
 * </p>
 *
 * @see mm.rdb.ops.OpsPackage#getAddIndex()
 * @model
 * @generated
 */
public interface AddIndex extends ModelOperation {
	 ...
	 * @see mm.rdb.ops.OpsPackage#getAddIndex_OwningSchemaName()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link mm.rdb.ops.AddIndex#getOwningSchemaName <em>Owning Schema Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see mm.rdb.ops.OpsPackage#getAddIndex_OwningTableName()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link mm.rdb.ops.AddIndex#getOwningTableName <em>Owning Table Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setName(String)
	 * @see mm.rdb.ops.OpsPackage#getAddIndex_Name()
	 * @model required="true"
	 * @generated
	 */
	String getName();
	...
	/**
	 * Sets the value of the '{@link mm.rdb.ops.AddIndex#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see mm.rdb.ops.OpsPackage#getAddIndex_ColumnsNames()
	 * @model required="true"
	 * @generated
	 */
