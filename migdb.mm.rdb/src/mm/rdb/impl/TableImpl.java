 ...
 * <ul>
 *   <li>{@link mm.rdb.impl.TableImpl#getOwningSchema <em>Owning Schema</em>}</li>
 *   <li>{@link mm.rdb.impl.TableImpl#getName <em>Name</em>}</li>
 *   <li>{@link mm.rdb.impl.TableImpl#getPrimaryKey <em>Primary Key</em>}</li>
 *   <li>{@link mm.rdb.impl.TableImpl#getColumns <em>Columns</em>}</li>
 *   <li>{@link mm.rdb.impl.TableImpl#getConstraints <em>Constraints</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TableImpl extends EObjectImpl implements Table {
	...
	public Schema getOwningSchema() {
		if (eContainerFeatureID() != RdbPackage.TABLE__OWNING_SCHEMA) return null;
	...
	public PrimaryKey getPrimaryKey() {
		if (primaryKey != null && primaryKey.eIsProxy()) {
			...
			if (primaryKey != oldPrimaryKey) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, RdbPackage.TABLE__PRIMARY_KEY, oldPrimaryKey, primaryKey));
			}
		}
		return primaryKey;
	}
	...
	public void setPrimaryKey(PrimaryKey newPrimaryKey) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RdbPackage.TABLE__PRIMARY_KEY, oldPrimaryKey, primaryKey));
	}
	...
	public EList<TableConstraint> getConstraints() {
		if (constraints == null) {
			constraints = new EObjectContainmentWithInverseEList<TableConstraint>(TableConstraint.class, this, RdbPackage.TABLE__CONSTRAINTS, RdbPackage.TABLE_CONSTRAINT__OWNING_TABLE);
		}
		return constraints;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case RdbPackage.TABLE__OWNING_SCHEMA:
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case RdbPackage.TABLE__OWNING_SCHEMA:
				return eBasicSetContainer(null, RdbPackage.TABLE__OWNING_SCHEMA, msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case RdbPackage.TABLE__OWNING_SCHEMA:
				return eInternalContainer().eInverseRemove(this, RdbPackage.SCHEMA__TABLES, Schema.class, msgs);
		}
