...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Add Not Null Constraint</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link mm.rdb.operations.impl.AddNotNullConstraintImpl#getOwningSchemaName <em>Owning Schema Name</em>}</li>
 *   <li>{@link mm.rdb.operations.impl.AddNotNullConstraintImpl#getOwningTableName <em>Owning Table Name</em>}</li>
 *   <li>{@link mm.rdb.operations.impl.AddNotNullConstraintImpl#getOwningColumnName <em>Owning Column Name</em>}</li>
 *   <li>{@link mm.rdb.operations.impl.AddNotNullConstraintImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class AddNotNullConstraintImpl extends ModelOperationImpl implements AddNotNullConstraint {
	/**
	 ...
	 * @generated
	 */
	protected AddNotNullConstraintImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return OperationsPackage.Literals.ADD_NOT_NULL_CONSTRAINT;
	}
	...
	public void setOwningSchemaName(String newOwningSchemaName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OperationsPackage.ADD_NOT_NULL_CONSTRAINT__OWNING_SCHEMA_NAME, oldOwningSchemaName, owningSchemaName));
	}
	...
	public void setOwningTableName(String newOwningTableName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OperationsPackage.ADD_NOT_NULL_CONSTRAINT__OWNING_TABLE_NAME, oldOwningTableName, owningTableName));
	}
	...
	public void setOwningColumnName(String newOwningColumnName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OperationsPackage.ADD_NOT_NULL_CONSTRAINT__OWNING_COLUMN_NAME, oldOwningColumnName, owningColumnName));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OperationsPackage.ADD_NOT_NULL_CONSTRAINT__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OperationsPackage.ADD_NOT_NULL_CONSTRAINT__OWNING_SCHEMA_NAME:
				return getOwningSchemaName();
			case OperationsPackage.ADD_NOT_NULL_CONSTRAINT__OWNING_TABLE_NAME:
				return getOwningTableName();
			case OperationsPackage.ADD_NOT_NULL_CONSTRAINT__OWNING_COLUMN_NAME:
				return getOwningColumnName();
			case OperationsPackage.ADD_NOT_NULL_CONSTRAINT__NAME:
				return getName();
		}
