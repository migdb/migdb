...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Remove Index</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link mm.rdb.operations.impl.RemoveIndexImpl#getOwningSchemaName <em>Owning Schema Name</em>}</li>
 *   <li>{@link mm.rdb.operations.impl.RemoveIndexImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class RemoveIndexImpl extends ModelOperationImpl implements RemoveIndex {
	/**
	...
	protected EClass eStaticClass() {
		return OperationsPackage.Literals.REMOVE_INDEX;
	}
	...
	public void setOwningSchemaName(String newOwningSchemaName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OperationsPackage.REMOVE_INDEX__OWNING_SCHEMA_NAME, oldOwningSchemaName, owningSchemaName));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OperationsPackage.REMOVE_INDEX__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OperationsPackage.REMOVE_INDEX__OWNING_SCHEMA_NAME:
				return getOwningSchemaName();
			case OperationsPackage.REMOVE_INDEX__NAME:
				return getName();
		}
