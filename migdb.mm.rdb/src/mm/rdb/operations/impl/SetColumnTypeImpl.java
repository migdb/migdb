 ...
 * <ul>
 *   <li>{@link mm.rdb.operations.impl.SetColumnTypeImpl#getOwningSchemaName <em>Owning Schema Name</em>}</li>
 *   <li>{@link mm.rdb.operations.impl.SetColumnTypeImpl#getOwningTableName <em>Owning Table Name</em>}</li>
 *   <li>{@link mm.rdb.operations.impl.SetColumnTypeImpl#getOwningColumnName <em>Owning Column Name</em>}</li>
 *   <li>{@link mm.rdb.operations.impl.SetColumnTypeImpl#getNewType <em>New Type</em>}</li>
 *   <li>{@link mm.rdb.operations.impl.SetColumnTypeImpl#getOldType <em>Old Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SetColumnTypeImpl extends ModelOperationImpl implements SetColumnType {
	...
	protected EClass eStaticClass() {
		return OperationsPackage.Literals.SET_COLUMN_TYPE;
	}
	...
	public void setOwningSchemaName(String newOwningSchemaName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OperationsPackage.SET_COLUMN_TYPE__OWNING_SCHEMA_NAME, oldOwningSchemaName, owningSchemaName));
	}
	...
	public void setOwningTableName(String newOwningTableName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OperationsPackage.SET_COLUMN_TYPE__OWNING_TABLE_NAME, oldOwningTableName, owningTableName));
	}
	...
	public void setOwningColumnName(String newOwningColumnName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OperationsPackage.SET_COLUMN_TYPE__OWNING_COLUMN_NAME, oldOwningColumnName, owningColumnName));
	}
	...
	public void setNewType(PrimitiveType newNewType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OperationsPackage.SET_COLUMN_TYPE__NEW_TYPE, oldNewType, newType));
	}
	...
	public void setOldType(PrimitiveType newOldType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OperationsPackage.SET_COLUMN_TYPE__OLD_TYPE, oldOldType, oldType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OperationsPackage.SET_COLUMN_TYPE__OWNING_SCHEMA_NAME:
				return getOwningSchemaName();
			case OperationsPackage.SET_COLUMN_TYPE__OWNING_TABLE_NAME:
				return getOwningTableName();
			case OperationsPackage.SET_COLUMN_TYPE__OWNING_COLUMN_NAME:
				return getOwningColumnName();
			case OperationsPackage.SET_COLUMN_TYPE__NEW_TYPE:
				return getNewType();
			case OperationsPackage.SET_COLUMN_TYPE__OLD_TYPE:
				return getOldType();
		}
