 ...
 * <ul>
 *   <li>{@link mm.rdb.operations.impl.RemoveDefaultValueImpl#getOwningSchemaName <em>Owning Schema Name</em>}</li>
 *   <li>{@link mm.rdb.operations.impl.RemoveDefaultValueImpl#getOwningTableName <em>Owning Table Name</em>}</li>
 *   <li>{@link mm.rdb.operations.impl.RemoveDefaultValueImpl#getOwningColumnName <em>Owning Column Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RemoveDefaultValueImpl extends ModelOperationImpl implements RemoveDefaultValue {
	...
	protected EClass eStaticClass() {
		return OperationsPackage.Literals.REMOVE_DEFAULT_VALUE;
	}
	...
	public void setOwningSchemaName(String newOwningSchemaName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OperationsPackage.REMOVE_DEFAULT_VALUE__OWNING_SCHEMA_NAME, oldOwningSchemaName, owningSchemaName));
	}
	...
	public void setOwningTableName(String newOwningTableName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OperationsPackage.REMOVE_DEFAULT_VALUE__OWNING_TABLE_NAME, oldOwningTableName, owningTableName));
	}
	...
	public void setOwningColumnName(String newOwningColumnName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OperationsPackage.REMOVE_DEFAULT_VALUE__OWNING_COLUMN_NAME, oldOwningColumnName, owningColumnName));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OperationsPackage.REMOVE_DEFAULT_VALUE__OWNING_SCHEMA_NAME:
				return getOwningSchemaName();
			case OperationsPackage.REMOVE_DEFAULT_VALUE__OWNING_TABLE_NAME:
				return getOwningTableName();
			case OperationsPackage.REMOVE_DEFAULT_VALUE__OWNING_COLUMN_NAME:
