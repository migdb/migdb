 ...
 * <ul>
 *   <li>{@link mm.rdb.operations.impl.GenerateSequenceNumbersImpl#getOwningSchemaName <em>Owning Schema Name</em>}</li>
 *   <li>{@link mm.rdb.operations.impl.GenerateSequenceNumbersImpl#getTableName <em>Table Name</em>}</li>
 *   <li>{@link mm.rdb.operations.impl.GenerateSequenceNumbersImpl#getColumnName <em>Column Name</em>}</li>
 *   <li>{@link mm.rdb.operations.impl.GenerateSequenceNumbersImpl#getSequenceName <em>Sequence Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class GenerateSequenceNumbersImpl extends ModelOperationImpl implements GenerateSequenceNumbers {
	...
	protected EClass eStaticClass() {
		return OperationsPackage.Literals.GENERATE_SEQUENCE_NUMBERS;
	}
	...
	public void setOwningSchemaName(String newOwningSchemaName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OperationsPackage.GENERATE_SEQUENCE_NUMBERS__OWNING_SCHEMA_NAME, oldOwningSchemaName, owningSchemaName));
	}
	...
	public void setTableName(String newTableName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OperationsPackage.GENERATE_SEQUENCE_NUMBERS__TABLE_NAME, oldTableName, tableName));
	}
	...
	public void setColumnName(String newColumnName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OperationsPackage.GENERATE_SEQUENCE_NUMBERS__COLUMN_NAME, oldColumnName, columnName));
	}
	...
	public void setSequenceName(String newSequenceName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OperationsPackage.GENERATE_SEQUENCE_NUMBERS__SEQUENCE_NAME, oldSequenceName, sequenceName));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OperationsPackage.GENERATE_SEQUENCE_NUMBERS__OWNING_SCHEMA_NAME:
				return getOwningSchemaName();
			case OperationsPackage.GENERATE_SEQUENCE_NUMBERS__TABLE_NAME:
				return getTableName();
			case OperationsPackage.GENERATE_SEQUENCE_NUMBERS__COLUMN_NAME:
				return getColumnName();
			case OperationsPackage.GENERATE_SEQUENCE_NUMBERS__SEQUENCE_NAME:
