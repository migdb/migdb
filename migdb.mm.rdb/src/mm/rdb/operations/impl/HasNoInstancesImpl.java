 ...
 * <ul>
 *   <li>{@link mm.rdb.operations.impl.HasNoInstancesImpl#getOwningSchemaName <em>Owning Schema Name</em>}</li>
 *   <li>{@link mm.rdb.operations.impl.HasNoInstancesImpl#getTableName <em>Table Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class HasNoInstancesImpl extends ModelOperationImpl implements HasNoInstances {
	...
	protected EClass eStaticClass() {
		return OperationsPackage.Literals.HAS_NO_INSTANCES;
	}
	...
	public void setOwningSchemaName(String newOwningSchemaName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OperationsPackage.HAS_NO_INSTANCES__OWNING_SCHEMA_NAME, oldOwningSchemaName, owningSchemaName));
	}
	...
	public void setTableName(String newTableName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OperationsPackage.HAS_NO_INSTANCES__TABLE_NAME, oldTableName, tableName));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OperationsPackage.HAS_NO_INSTANCES__OWNING_SCHEMA_NAME:
				return getOwningSchemaName();
			case OperationsPackage.HAS_NO_INSTANCES__TABLE_NAME:
				return getTableName();
		}
