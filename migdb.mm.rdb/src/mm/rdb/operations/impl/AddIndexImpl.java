 ...
 * <ul>
 *   <li>{@link mm.rdb.operations.impl.AddIndexImpl#getOwningSchemaName <em>Owning Schema Name</em>}</li>
 *   <li>{@link mm.rdb.operations.impl.AddIndexImpl#getOwningTableName <em>Owning Table Name</em>}</li>
 *   <li>{@link mm.rdb.operations.impl.AddIndexImpl#getName <em>Name</em>}</li>
 *   <li>{@link mm.rdb.operations.impl.AddIndexImpl#getColumnsNames <em>Columns Names</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AddIndexImpl extends ModelOperationImpl implements AddIndex {
	...
	protected EClass eStaticClass() {
		return OperationsPackage.Literals.ADD_INDEX;
	}
	...
	public void setOwningSchemaName(String newOwningSchemaName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OperationsPackage.ADD_INDEX__OWNING_SCHEMA_NAME, oldOwningSchemaName, owningSchemaName));
	}
	...
	public void setOwningTableName(String newOwningTableName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OperationsPackage.ADD_INDEX__OWNING_TABLE_NAME, oldOwningTableName, owningTableName));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OperationsPackage.ADD_INDEX__NAME, oldName, name));
	}
	...
	public EList<String> getColumnsNames() {
		if (columnsNames == null) {
			columnsNames = new EDataTypeUniqueEList<String>(String.class, this, OperationsPackage.ADD_INDEX__COLUMNS_NAMES);
		}
		return columnsNames;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OperationsPackage.ADD_INDEX__OWNING_SCHEMA_NAME:
				return getOwningSchemaName();
			case OperationsPackage.ADD_INDEX__OWNING_TABLE_NAME:
				return getOwningTableName();
			case OperationsPackage.ADD_INDEX__NAME:
				return getName();
			case OperationsPackage.ADD_INDEX__COLUMNS_NAMES:
