 ...
 * <ul>
 *   <li>{@link mm.rdb.operations.SetColumnDefaultValue#getOwningSchemaName <em>Owning Schema Name</em>}</li>
 *   <li>{@link mm.rdb.operations.SetColumnDefaultValue#getOwningTableName <em>Owning Table Name</em>}</li>
 *   <li>{@link mm.rdb.operations.SetColumnDefaultValue#getOwningColumnName <em>Owning Column Name</em>}</li>
 *   <li>{@link mm.rdb.operations.SetColumnDefaultValue#getNewDefaultValue <em>New Default Value</em>}</li>
 * </ul>
 * </p>
 *
 * @see mm.rdb.operations.OperationsPackage#getSetColumnDefaultValue()
 * @model
 * @generated
 */
public interface SetColumnDefaultValue extends ModelOperation {
	 ...
	 * @see mm.rdb.operations.OperationsPackage#getSetColumnDefaultValue_OwningSchemaName()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link mm.rdb.operations.SetColumnDefaultValue#getOwningSchemaName <em>Owning Schema Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see mm.rdb.operations.OperationsPackage#getSetColumnDefaultValue_OwningTableName()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link mm.rdb.operations.SetColumnDefaultValue#getOwningTableName <em>Owning Table Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see mm.rdb.operations.OperationsPackage#getSetColumnDefaultValue_OwningColumnName()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link mm.rdb.operations.SetColumnDefaultValue#getOwningColumnName <em>Owning Column Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see mm.rdb.operations.OperationsPackage#getSetColumnDefaultValue_NewDefaultValue()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link mm.rdb.operations.SetColumnDefaultValue#getNewDefaultValue <em>New Default Value</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
