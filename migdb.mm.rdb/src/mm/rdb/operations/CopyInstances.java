 ...
 * <ul>
 *   <li>{@link mm.rdb.operations.CopyInstances#getOwningSchemaName <em>Owning Schema Name</em>}</li>
 *   <li>{@link mm.rdb.operations.CopyInstances#getOwningTableName <em>Owning Table Name</em>}</li>
 *   <li>{@link mm.rdb.operations.CopyInstances#getSourceColumnName <em>Source Column Name</em>}</li>
 *   <li>{@link mm.rdb.operations.CopyInstances#getTargetTableName <em>Target Table Name</em>}</li>
 *   <li>{@link mm.rdb.operations.CopyInstances#getTargetColumnName <em>Target Column Name</em>}</li>
 *   <li>{@link mm.rdb.operations.CopyInstances#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @see mm.rdb.operations.OperationsPackage#getCopyInstances()
 * @model
 * @generated
 */
public interface CopyInstances extends ModelOperation {
	 ...
	 * @see mm.rdb.operations.OperationsPackage#getCopyInstances_OwningSchemaName()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link mm.rdb.operations.CopyInstances#getOwningSchemaName <em>Owning Schema Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see mm.rdb.operations.OperationsPackage#getCopyInstances_OwningTableName()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link mm.rdb.operations.CopyInstances#getOwningTableName <em>Owning Table Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see mm.rdb.operations.OperationsPackage#getCopyInstances_SourceColumnName()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link mm.rdb.operations.CopyInstances#getSourceColumnName <em>Source Column Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see mm.rdb.operations.OperationsPackage#getCopyInstances_TargetTableName()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link mm.rdb.operations.CopyInstances#getTargetTableName <em>Target Table Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see mm.rdb.operations.OperationsPackage#getCopyInstances_TargetColumnName()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link mm.rdb.operations.CopyInstances#getTargetColumnName <em>Target Column Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The literals are from the enumeration {@link mm.rdb.operations.MergeType}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see mm.rdb.operations.OperationsPackage#getCopyInstances_Type()
	 * @model required="true"
	 * @generated
	 */
	MergeType getType();
	...
	/**
	 * Sets the value of the '{@link mm.rdb.operations.CopyInstances#getType <em>Type</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
