...
public class OperationsSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case OperationsPackage.REMOVE_SEQUENCE: {
			...
			case OperationsPackage.ADD_INSTANCES: {
			...
			case OperationsPackage.INSERT_INSTANCES: {
			...
			case OperationsPackage.GENERATE_SEQUENCE_NUMBERS: {
