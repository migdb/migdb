...
public class OpsLaunchDelegate extends JavaLaunchDelegate {

	private static final Logger logger = Logger.getLogger(OpsLaunchDelegate.class);
					...
					for (int i = 0; i < events.length; i++) {
						...
						if (event.getSource() instanceof IProcess && event.getKind() == DebugEvent.TERMINATE) {
							...
							if (configuration == process.getLaunch().getLaunchConfiguration()) {
								...
								Job job = new Job("Refreshing after ops launch") {
